# Security MCP Server - Development Scripts
...
python -m virons.security_mcp_server.server --transport api
```
...
#!/bin/bash
cd "$(dirname "$0")/../.."
pytest tests/ -v --cov=virons.security_mcp_server --cov-report=html --cov-report=term
