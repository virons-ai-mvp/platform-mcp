                    ...
                    for svc in cfg.services:
                        ...
                        for attempt in range(3):
                            try:
                                ...
                                logger.info(f"Discovered tools from {svc.name}: {len(service_registry._tool_metadata)} total")
                                break
                            except Exception as e:
                                if attempt < 2:
                                    await asyncio.sleep(1)
                                else:
                                    logger.warning(f"Failed to discover tools from {svc.name} after 3 attempts")
    ...
    @app.post("/tools/{tool_name}", 
              ...
              responses={
                  ...
                  400: {
                      ...
                      "content": {"application/json": {"example": {"error": "Invalid JSON: Expecting value at line 1"}}}
                  },
                  401: {
                      "description": "Authentication required. Include 'Authorization: Bearer <token>' header in your request.",
                      "content": {"application/json": {"example": {"error": "Missing authorization header"}}}
                  },
                  404: {
                      ...
                      "content": {"application/json": {"example": {"error": "Tool 'unknown_tool' not found"}}}
                  },
                  500: {
                      "description": "Internal server error. An unexpected error occurred in the gateway. Check logs for details.",
                      "content": {"application/json": {"example": {"error": "Internal processing error"}}}
                  },
                  502: {
                      ...
                      "content": {"application/json": {"example": {"error": "Backend service connection failed"}}}
                  },
                  503: {
                      "description": "Service unavailable. The gateway or backend service is temporarily unavailable. Retry after a short delay.",
                      "content": {"application/json": {"example": {"error": "Service temporarily unavailable"}}}
                  },
              })
    ...
    @app.get("/tools",
             ...
             responses={
                 200: {
                     ...
                     "content": {"application/json": {"example": {"tools": [{"name": "deploy_infrastructure", "service": "infrastructure-mcp"}]}}}
                 },
                 500: {
                     ...
                     "content": {"application/json": {"example": {"error": "Failed to retrieve tools"}}}
                 },
             })
    ...
    @app.get("/health",
             ...
             responses={
                 200: {
                     ...
                     "content": {"application/json": {"example": {"status": "healthy", "gateway": "virons-mcp-gateway"}}}
                 },
                 503: {
                     ...
                     "content": {"application/json": {"example": {"status": "unhealthy", "error": "Component failure"}}}
                 },
             })
    async def health():
    ...
    @app.get("/ready",
             ...
             responses={
                 200: {
                     ...
                     "content": {"application/json": {"example": {"ready": True, "services": {"infrastructure-mcp": "healthy"}}}}
                 },
                 503: {
                     ...
                     "content": {"application/json": {"example": {"ready": False, "services": {"infrastructure-mcp": "unhealthy"}}}}
                 },
             })
    async def ready():
    ...
    @app.get("/metrics",
             ...
             responses={
                 ...
                 500: {
                     ...
                     "content": {"application/json": {"example": {"error": "Metrics generation failed"}}}
                 },
             })
    async def metrics():
    ...
    @app.get("/",
             ...
             responses={
                 200: {
                     ...
                     "content": {"application/json": {"example": {"service": "virons-mcp-gateway", "version": "1.0.0", "endpoints": {}}}}
                 },
             })
    async def root():
