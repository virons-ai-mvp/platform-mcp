...
Infrastructure orchestrator - wraps CDK, CloudFormation, Terraform, IaC MCP servers

**Port**: 9140 | **Status**: 🟢 Scaffolded | **Compliance**: ✅ Born Compliant

## Overview

Virons AI MCP server for infrastructure operations. This server follows Domain-Driven Design (DDD) and Test-Driven Development (TDD) principles, with compliance built-in from day one.
...
Edit `virons/infrastructure_mcp_server/server.py`:
...
**Generated by**: `virons-scaffold` | **Domain**: Server Domain | **Context**: Infrastructure MCP Server
